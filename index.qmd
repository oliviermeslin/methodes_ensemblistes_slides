...
## Champ couvert par le document de travail {.smaller}

Principe: présenter en détail un nombre réduit d'approches:

- Méthodes ensemblistes à base d'arbres:
...
- Aspects non couverts: 
    - Méthodes: _stacking_, _boosting_ adaptatif;
    - Mesure de l'incertitude (notamment la prédiction conforme).
