...
- Usages possibles:  
  ...
  - Clustering spatial: construction de zones spatiales homogènes 
...
- Avantages:
  - La bande passante implicite est variable: 
    - A COMPLETER AVEC DES ELEMENTS DU DT PRIX (points chauds, etc.)
  - Approche performante sur le plan computationnel;
- Risque: surapprentissage.


## Modélisation spatiale {.smaller}
