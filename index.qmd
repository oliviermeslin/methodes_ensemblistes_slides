...
- Objectif: identification et représentation spatiale de groupes homogènes

- Pourquoi faire du lissage ou clustering spatial ?
  - Représentation cartographique: réduire le bruit pour faire apparaitre des tendances ou des groupes d'intérêt
  - Analyse économétrique: identifier des zones spatiales homogènes 
